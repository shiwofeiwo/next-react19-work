 ...
 * @api Dialog
 */
export interface DialogV1Props extends Omit<HTMLAttributes, 'content' | 'title'>, CommonProps {
    /**
     * 是否显示
     * @en Whether to show
     * @defaultValue false
    ...
    /**
     * 定制关闭按钮 icon
     * @en Customize the close button icon
     * @version 1.25
     */
 ...
 * @api Dialog V2
 */
export interface DialogV2Props extends Omit<HTMLAttributes, 'content' | 'title'>, CommonProps {
    /**
     * 是否显示
     * @en Whether to show
     * @defaultValue false
...
export type DialogProps = DialogV1Props | DialogV2Props;
...
interface ModelV1Props
    extends DialogV1Props,
        CommonModelProps,
        Omit<ShowModalInnerProps, 'locale'> {}

interface ModelV2Props
    extends DialogV2Props,
        CommonModelProps,
        Omit<ShowModalInnerProps, 'locale'> {}
...
export interface ShowConfigV1 extends ModelV1Props, CommonConfig {}

export interface ShowConfigV2 extends ModelV2Props, CommonConfig {}

export type ShowConfig = ShowConfigV1 | ShowConfigV2;

export type ModelProps = ModelV1Props | ModelV2Props;
